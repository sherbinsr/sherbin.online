...
const links = [
  {
    label: "Email",
    value: "sherbinsyles31@gmail.com",
    href: "mailto:sherbinsyles31@gmail.com",
    icon: "✉",
    color: "var(--accent)",
  },
  {
    label: "LinkedIn",
    value: "sherbin-s-07704a249",
    href: "https://www.linkedin.com/in/sherbin-s-07704a249/",
    icon: "in",
    color: "var(--accent)",
  },
  {
